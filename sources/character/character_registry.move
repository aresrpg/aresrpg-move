...
use aresrpg::string::contains_whitespace;
use std::string::{Self, String};
use sui::{table::{Self, Table}, tx_context::sender};
...
public(package) fun add_name(self: &mut NameRegistry, name: String, ctx: &TxContext) {
...
public(package) fun remove_name(self: &mut NameRegistry, name: String) {
